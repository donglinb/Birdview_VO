...
int IcpSolver::FindRtICP(const vector<cv::Point3f> &vKeysXYZ1, const vector<cv::Point3f> &vKeysXYZ2, const vector<Match> &vMatches,
                         vector<bool> &vbMatchesInliers, cv::Mat &R, cv::Mat &t, float sigma) const
{
...
int IcpSolver::FindRtICP2D(const vector<cv::Point2f> &vKeysXY1, const vector<cv::Point2f> &vKeysXY2, const vector<Match> &vMatches,
                            vector<bool> &vbMatchesInliers, cv::Mat &R, cv::Mat &t, float sigma) const
{
    const int N = vMatches.size();
    // Indices for minimum set selection
